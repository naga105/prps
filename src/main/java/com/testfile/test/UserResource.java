...
//         Check if username is true or not
        ...
        if (checkUsername) {
            ...
            return Response.status(400).entity("Wrong username or username does not exist").build();
        }
...
//        Check if username existed
        ...
        if (!checkUsername) {
            ...
            return Response.status(400).entity("Existed username").build();
        }
...
//        Check if change password success or not
        ...
        if (checkChange) {
            ...
            return Response.status(400).entity("Failed to change password").build();
        }
